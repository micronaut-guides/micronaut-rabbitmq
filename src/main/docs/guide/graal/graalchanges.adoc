...
## Changes to books to generate a GraalVM native image


Modify `books/build.gradle`, add the annotation processor and `svm` dependency:

[source, groovy]
.books/build.gradle
----
include::{sourceDir}/books/build.gradle[tag=micronaut-graal]
include::{sourceDir}/books/build.gradle[tag=svm]
----

Add a `native-image.properties` inside `src/main/resources/META-INF/native-image/example.micronaut/books` folder.

[source, bash]
.src/main/resources/META-INF/native-image/example.micronaut/books/native-image.properties
----
include::{sourceDir}/books/src/main/resources/META-INF/native-image/example.micronaut/books/native-image.properties[]
----
...
## Changes to analytics to generate a GraalVM native image

Modify `analytics/build.gradle`, add the annotation processor and `svm` dependency:

[source, groovy]
.analytics/build.gradle
----
include::{sourceDir}/analytics/build.gradle[tag=micronaut-graal]
include::{sourceDir}/analytics/build.gradle[tag=svm]
----

Add a `native-image.properties` inside `src/main/resources/META-INF/native-image/example.micronaut/analytics` folder.

[source, bash]
.src/main/resources/META-INF/native-image/example.micronaut/analytics/native-image.properties
----
include::{sourceDir}/analytics/src/main/resources/META-INF/native-image/example.micronaut/analytics/native-image.properties[]
----